...
#import "flightTableView.h"

@interface flightTableView ()

@end

@implementation flightTableView
...
- (void)viewDidLoad
{
    ...
    [self setBackgroundView:[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"background"]]];
